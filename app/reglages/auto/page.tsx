...
export default function AutoCounterSettings() {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      ...
      >
        <nav className="mb-2 flex items-center gap-2 text-sm text-[var(--secondary)]">
          <Link href="/reglages">{t("settingsTitle")}</Link>
          <span>/</span>
          <span>{t("autoCounterTitle")}</span>
        </nav>
        <header className="mb-2">
          <h1 className="text-xl font-bold">{t("autoCounterTitle")}</h1>
