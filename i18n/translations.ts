export const translations = {
  fr: {
    ...
    settings: {
      ...
      autoAdvanceHint: "En mode sélection, passe automatiquement au zikr suivant quand l'objectif est atteint",
        selectionModeTitle: "Mode de sélection",
  ...
  en: {
    ...
    settings: {
      ...
      autoAdvanceHint: "In selection mode, automatically moves to the next zikr when the goal is reached",
